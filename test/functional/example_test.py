...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the TechcoinTestFramework
    pass


class ExampleTest(TechcoinTestFramework):
    # Each functional test is a subclass of the TechcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        TechcoinTestFramework class so other tests can use it."""

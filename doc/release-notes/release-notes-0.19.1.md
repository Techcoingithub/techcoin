...
Techcoin Core version 0.19.1 is now available from:

  <https://techcoincore.org/bin/techcoin-core-0.19.1/>
...
From Techcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Techcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Techcoin Core does not yet change appearance when
...
- #17488 fix "techcoind already running" warnings on macOS (fanquake)

...
#ifndef TECHCOIN_TEST_SCRIPTNUM10_H
#define TECHCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Techcoin Core 0.10.0, for cross-comparison.
 */
public:

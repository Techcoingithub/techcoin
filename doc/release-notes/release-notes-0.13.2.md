Techcoin Core version 0.13.2 is now available from:

  <https://techcoin.org/bin/techcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update techcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow techcoin-tx to create v2 transactions (tlcdrak)

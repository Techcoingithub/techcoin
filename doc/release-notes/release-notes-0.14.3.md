Techcoin Core version *0.14.3* is now available from:

  <https://techcoin.org/bin/techcoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/techcoind.openrcconf: Don't disable wallet by default (Luke Dashjr)

...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Techcoin
else
  DOCKER_EXEC echo \> \$HOME/.techcoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/techcoin/techcoin/pull/18288#discussion_r433189350 for
  # details.

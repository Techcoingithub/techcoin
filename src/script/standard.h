...
#ifndef TECHCOIN_SCRIPT_STANDARD_H
#define TECHCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a techcoin address
 */
...
/**
 * Generate a Techcoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // TECHCOIN_SCRIPT_STANDARD_H

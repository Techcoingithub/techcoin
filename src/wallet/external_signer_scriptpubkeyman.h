...
#ifndef TECHCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define TECHCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // TECHCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H

...
#ifndef TECHCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define TECHCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Techcoin Core wallet was originally a collection of unrelated private
...
#endif // TECHCOIN_WALLET_SCRIPTPUBKEYMAN_H

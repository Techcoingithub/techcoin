    ...
    mapper(nullptr)
{
    ...
    ui->techcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->techcoinAtStartup);
    ...
    ui->techcoinAtStartup->setToolTip(ui->techcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->techcoinAtStartup->setText(ui->techcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openTechcoinConfButton->setToolTip(ui->openTechcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new TechcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->techcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openTechcoinConfButton_clicked()
{

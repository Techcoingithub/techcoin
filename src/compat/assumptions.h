...
#ifndef TECHCOIN_COMPAT_ASSUMPTIONS_H
#define TECHCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Techcoin cannot be compiled without assertions."
#endif
...
#endif // TECHCOIN_COMPAT_ASSUMPTIONS_H

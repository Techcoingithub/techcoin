Techcoin Core version 0.9.2.1 is now available from:

  https://techcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 TLC to 0.01 TLC
...
- Fix "Start techcoin on system login"

...
#ifndef TECHCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define TECHCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@techcoin.
 *
 ...
 *
 * The chacha20-poly1305@techcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@techcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@techcoin are relatively fast in
...
#endif // TECHCOIN_CRYPTO_CHACHA_POLY_AEAD_H

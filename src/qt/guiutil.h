...
#ifndef TECHCOIN_QT_GUIUTIL_H
#define TECHCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Techcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "techcoin:" URI into recipient object, return true on successful parsing

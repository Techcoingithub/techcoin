 ...
 * for both techcoind and techcoin-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Techcoin");
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/techcoin/bips/blob/master/bip-0014.mediawiki)
 */

...
#ifndef TECHCOIN_WALLET_WALLETUTIL_H
#define TECHCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! techcoin from opening the wallet, thinking it was newly created, and
...
#endif // TECHCOIN_WALLET_WALLETUTIL_H

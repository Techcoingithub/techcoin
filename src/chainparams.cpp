...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.techcoin.sipa.be"); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me"); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.techcoin.dashjr.org"); // Luke Dashjr
        vSeeds.emplace_back("seed.techcoinstats.com"); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.techcoin.jonasschnelli.ch"); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.tlc.petertodd.org"); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.techcoin.sprovoost.nl"); // Sjors Provoost
        vSeeds.emplace_back("dnsseed.emzy.de"); // Stephan Oeste
        vSeeds.emplace_back("seed.techcoin.wiz.biz"); // Jason Maurice
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.techcoin.jonasschnelli.ch");
        vSeeds.emplace_back("seed.ttlc.petertodd.org");
        vSeeds.emplace_back("seed.testnet.techcoin.sprovoost.nl");

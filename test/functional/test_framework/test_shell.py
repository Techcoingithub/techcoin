...
class TestShell:
    """Wrapper Class for TechcoinTestFramework.

    The TestShell class extends the TechcoinTestFramework
    ...
    class __TestShell(TechcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by TechcoinTestFramework child class.
            self.num_nodes = 1

...
#ifndef TECHCOIN_WALLET_ISMINE_H
#define TECHCOIN_WALLET_ISMINE_H
 ...
 * https://github.com/techcoin/techcoin/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // TECHCOIN_WALLET_ISMINE_H

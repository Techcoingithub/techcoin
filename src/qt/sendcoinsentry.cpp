    ...
    platformStyle(_platformStyle)
{
    ...
    // normal techcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying techcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &TechcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);

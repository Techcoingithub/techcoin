...
// For details see https://github.com/techcoin/techcoin/pull/22348.
...
const char * const TECHCOIN_CONF_FILENAME = "techcoin.conf";
const char * const TECHCOIN_SETTINGS_FILENAME = "settings.json";
 ...
 * https://github.com/techcoin/techcoin/pull/16097#issuecomment-514627823
 */
...
bool ArgsManager::ParseParameters(int argc, const char* const argv[], std::string& error)
{
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (key == "-") break; //techcoin-tx using stdin
        std::string val;
...
bool ArgsManager::GetSettingsPath(fs::path* filepath, bool temp) const
{
    ...
    if (filepath) {
        std::string settings = GetArg("-settings", TECHCOIN_SETTINGS_FILENAME);
...
{
    // Windows: C:\Users\Username\AppData\Roaming\Techcoin
    // macOS: ~/Library/Application Support/Techcoin
    // Unix-like: ~/.techcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Techcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Techcoin";
#else
    // Unix-like
    return pathRet / ".techcoin";
#endif
#endif
}
...
bool ArgsManager::ReadConfigFiles(std::string& error, bool ignore_invalid_keys)
{
    ...
    const std::string confPath = GetArg("-conf", TECHCOIN_CONF_FILENAME);

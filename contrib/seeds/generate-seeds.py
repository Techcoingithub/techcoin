...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef TECHCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define TECHCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the techcoin network\n')
    ...
    g.write('#endif // TECHCOIN_CHAINPARAMSSEEDS_H\n')

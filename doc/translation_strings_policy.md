...
This document provides guidelines for internationalization of the Techcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `techcoin_en.ts` remains unchanged.

Techcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/techcoin/files/Techcoin/techcoin-0.5.4/
...
http://gitorious.org/techcoin/techcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Techcoin-Qt notifications under Growl 1.3.
Increase required age of Techcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxTechcoin properly when installing Techcoin-Qt over it. (Windows)

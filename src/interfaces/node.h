...
#ifndef TECHCOIN_INTERFACES_NODE_H
#define TECHCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a techcoin node (techcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // TECHCOIN_INTERFACES_NODE_H

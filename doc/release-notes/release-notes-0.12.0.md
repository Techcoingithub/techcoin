...
Then, to tunnel a SSL connection on 28862 to a RPC server bound on localhost on port 18862 do:

    stunnel -d 28862 -r 127.0.0.1:18862 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ProxyPass http://127.0.0.1:8862/
        ProxyPassReverse http://127.0.0.1:8862/

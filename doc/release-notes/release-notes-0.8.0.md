Techcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/techcoin/files/Techcoin/techcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Techcoin
...
New/changed settings (command-line or techcoin.conf file)
--------------------------------------------------------

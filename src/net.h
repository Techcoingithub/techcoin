...
#ifndef TECHCOIN_NET_H
#define TECHCOIN_NET_H
 ...
 * src/qt/guiutil.cpp and src/techcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Techcoin’s Peer-to-Peer Network")

Techcoin Core version 0.10.4 is now available from:

  <https://techcoin.org/bin/techcoin-core-0.10.4/>
...
- #6953 `43c2789` Split techcoin-tx into its own package
- #6953 `dfe0d4d` Include techcoin-tx binary on Debian/Ubuntu

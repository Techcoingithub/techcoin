...
"""
Test starting techcoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(TechcoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that techcoind has bound on "::1" (for RPC) and "::" (for P2P).

...
class BumpFeeTest(TechcoinTestFramework):
    ...
    def run_test(self):
        ...
        # fund rbf node with 10 coins of 0.001 tlc (100,000 satoshis)
    ...
    def test_invalid_parameters(self, rbf_node, peer_node, dest_address):
        ...
        for mode in ["foo", Decimal("3.1415"), "sat/B", "TLC/kB"]:
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # The DER formatting used by Techcoin to serialize ECDSA signatures means that signatures can have a
    ...
    # Expected fee is 141 vbytes * fee_rate 0.00350250 TLC / 1000 vbytes = 0.00049385 TLC.
    # or occasionally 140 vbytes * fee_rate 0.00350250 TLC / 1000 vbytes = 0.00049035 TLC.
    # Dust should be dropped to the fee, so actual bump fee is 0.00050000 TLC.
...
def test_maxtxfee_fails(self, rbf_node, dest_address):
    ...
    # expected bump fee of 141 vbytes * 0.00200000 TLC / 1000 vbytes = 0.00002820 TLC

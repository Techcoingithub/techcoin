...
// techcoin includes.
#include <..\src\script\techcoinconsensus.h>
...
int main()
{
    std::cout << "techcoinconsensus version: " << techcoinconsensus_version() << std::endl;
    ...
    auto op0Result = techcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, techcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);

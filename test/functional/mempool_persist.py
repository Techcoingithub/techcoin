...
By default, techcoind will dump mempool on shutdown and
...
class MempoolPersistTest(TechcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent techcoind from writing mempool.dat to disk. Verify that `savemempool` fails")

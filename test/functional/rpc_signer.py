...
Verify that a techcoind node can use an external signer command.
...
class RPCSignerTest(TechcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart techcoind with -signer=<cmd>',

...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the techcoin repository."
  exit 1
fi
...
# See https://github.com/techcoin/techcoin/issues/16064
...
echo 'When compiling techcoind, run `./configure` in the following way:'
echo

...
(define* (make-techcoin-cross-toolchain target
                                       #:key
...
desirable for building Techcoin Core release binaries."
...
(define glibc-2.27/techcoin-patched
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-techcoin-cross-toolchain target
                                                      #:base-libc glibc-2.27/techcoin-patched

...
//! Entry point for TechcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &TechcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for TechcoinGUI tests.
void AppTests::guiTests(TechcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &TechcoinGUI::consoleShown, this, &AppTests::consoleTests);

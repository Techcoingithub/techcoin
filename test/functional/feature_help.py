...
"""Verify that starting techcoin with -h works as expected."""

from test_framework.test_framework import TechcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(TechcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start techcoin with -h for help text")
        ...
        self.log.info("Start techcoin with -version for version information")
        ...
        self.log.info("Start techcoind with -fakearg to make sure it does not start")

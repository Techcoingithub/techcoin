Techcoin Core version 0.16.1 is now available from:

  <https://techcoincore.org/bin/techcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting techcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure techcoind processes are cleaned up when tests end (sdaftuar)

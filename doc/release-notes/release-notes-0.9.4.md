Techcoin Core version 0.9.4 is now available from:

  https://techcoin.org/bin/0.9.4/
...
this update is incompatible with the Techcoin system and could lead to consensus
forks.

Techcoin Core released binaries from https://techcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~techcoin/+archive/ubuntu/techcoin
- A third-party or self-compiled Techcoin Core

upgrade to Techcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

 ...
 */
#ifndef TECHCOIN_UTIL_SYSTEM_H
#define TECHCOIN_UTIL_SYSTEM_H
...
extern const char * const TECHCOIN_CONF_FILENAME;
extern const char * const TECHCOIN_SETTINGS_FILENAME;

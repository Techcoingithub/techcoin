...
class P2PPermissionsTests(TechcoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].techcoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].techcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)

...
class ZMQTest (TechcoinTestFramework):
    ...
    def test_sequence(self):
        ...
        [seq] = self.setup_zmq_test([("sequence", "tcp://127.0.0.1:28863")])
        self.disconnect_nodes(0, 1)
